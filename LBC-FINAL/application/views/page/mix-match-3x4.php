...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "jquery.watch.js", "require.js", "mix-match-3x4.css"], "outOfDate":[]};
</script>
  
  <link rel="shortcut icon" href="<?php echo base_url(); ?>images/mix-match-3x4-favicon.ico?crc=3970908141"/>
  <title>Mix&amp;Match | 3x4</title>
  <!-- CSS -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/site_global.css?crc=384580191"/>
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/mix-match-3x4.css?crc=245886840" id="pagesheet"/>
  <!-- JS includes -->
  <!--[if lt IE 9]>
 ...
 <body class="museBGSize">
  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   <div class="colelem" id="u133028"><!-- custom html -->

<div id="holder34">
<div id="container34">
    <div id="div1" class="square34" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
    <div id="div2" class="square34" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
    <div id="div3" class="square34" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
    <div id="div4" class="square34" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
    <div id="div5" class="square34" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
    <div id="div6" class="square34" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
    <div id="div7" class="square34" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
    <div id="div8" class="square34" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
    <div id="div9" class="square34" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
    <div id="div10" class="square34" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
    <div id="div11" class="square34" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
    <div id="div12" class="square34" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
</div>
<div id="order">
...
<?php echo form_error('orderdata10'); ?>
<?php echo form_error('orderdata11'); ?>
<?php echo form_error('orderdata12'); ?>
...
<script type="text/javascript">
      function order(){
        ...
        document.getElementById("orderdata10").value = "";
        document.getElementById("orderdata11").value = "";
        document.getElementById("orderdata12").value = "";
        ...
        if(div10.querySelector('#box') != null){
          var box10 = div10.querySelector('#box').src;
          document.getElementById("orderdata10").value = box10;
        }
        if(div11.querySelector('#box') != null){
          var box11 = div11.querySelector('#box').src;
          document.getElementById("orderdata11").value = box11;
        }
        if(div12.querySelector('#box') != null){
          var box12 = div12.querySelector('#box').src;
          document.getElementById("orderdata12").value = box12;
        }
    ...
    <!--<form action="mailto:greetings.ambawani@gmail.com" method="post" enctype="text/plain"> action perlu diganti -->
        ...
        <input type="hidden" id="orderdata9" name="orderdata9">
        <input type="hidden" id="orderdata10" name="orderdata10">
        <input type="hidden" id="orderdata11" name="orderdata11">
        <input type="hidden" id="orderdata12" name="orderdata12"> <!-- Order Data -->
        </div>
...
var muse_init=function(){
      ...
      if(window.location.pathname == "/LBC-FINAL/index.php/Controller/MixMatch3x4") require.config({baseUrl:"../.."});
