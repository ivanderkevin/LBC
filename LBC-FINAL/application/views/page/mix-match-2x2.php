...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "jquery.watch.js", "require.js", "mix-match-2x2.css"], "outOfDate":[]};
</script>
  
  <link rel="shortcut icon" href="<?php echo base_url(); ?>images/mix-match-2x2-favicon.ico?crc=3970908141"/>
  <title>Mix&amp;Match | 2x2</title>
  <!-- CSS -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/site_global.css?crc=384580191"/>
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/mix-match-2x2.css?crc=4033539952" id="pagesheet"/>
  <!-- JS includes -->
  <!--[if lt IE 9]>
 ...
 <body class="museBGSize">
  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   <div class="colelem" id="u131783"><!-- custom html -->
...
<div id="holder22">
<div id="container22">
    <div id="div1" class="square22" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
    <div id="div2" class="square22" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
    <div id="div3" class="square22" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
    <div id="div4" class="square22" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
</div>
<div id="order">
...
<script type="text/javascript">
    ...
    <!--<form action="mailto:greetings.ambawani@gmail.com" method="post" enctype="text/plain"> action perlu diganti -->
        ...
        <input type="hidden" id="orderdata4" name="orderdata4"> <!-- Order Data -->
        </div>
...
var muse_init=function(){
      ...
      if(window.location.pathname == "/LBC-FINAL/index.php/Controller/MixMatch2x2") require.config({baseUrl:"../.."});
